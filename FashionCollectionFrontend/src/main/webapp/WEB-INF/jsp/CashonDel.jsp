...
<div class="myDiv">
<h1 style="color: orange;">Cash on Delivery</h1>
</div>
<div class="row">
  <div class="col-75">
    <div class="container">
     	<form:form action="registercashondel" modelAttribute="cashondel" method="post">
...
<button type="button" class="btn btn-blue btn-lg btn-block">Pay on Delivery</button>
      </form:form>
        </div>
    </div>
  </div>
